...
public class Panel extends JPanel {
	...
	public int numero3() {
		return Integer.parseInt(this.numero3.getText());
	}
	...
	public void escribePrimosTwin(List<Primos> list) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			if((p.getPos()+1)%5==0)listaPrimos1.append("\n");
		}
	...
	public void escribePrimosCousin(List<Primos> list) {
		for (int i = 0; i < list.size(); i++) {
			...
			if((p.getPos()+1)%5==0)listaPrimos2.append("\n");
		}
	}
	...
	public void escribePrimosSexy(List<Primos> list) {
		for (int i = 0; i < list.size(); i++) {
			...
			if((p.getPos()+1)%5==0)listaPrimos3.append("\n");
		}
	}
